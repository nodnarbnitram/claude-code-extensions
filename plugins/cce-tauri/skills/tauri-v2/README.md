...
The `tauri-v2-expert` agent at `${CLAUDE_PLUGIN_ROOT}/agents/specialized/tauri/tauri-v2-expert.md` is **deprecated/legacy**. This skill is the preferred and actively maintained interface. Use this skill over the agent for all new Tauri v2 work.
