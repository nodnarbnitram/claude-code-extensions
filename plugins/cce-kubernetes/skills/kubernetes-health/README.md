...
uv run ${CLAUDE_PLUGIN_ROOT}/skills/kubernetes-health/scripts/health_orchestrator.py

# Aggregate results (after agents complete)
uv run ${CLAUDE_PLUGIN_ROOT}/skills/kubernetes-health/scripts/aggregate_report.py
```
