...
Copy the skeleton template from `templates/skill-skeleton/` to `${CLAUDE_PLUGIN_ROOT}/skills/<skill-name>/`:
...
Write all files to `${CLAUDE_PLUGIN_ROOT}/skills/<skill-name>/`:
```
