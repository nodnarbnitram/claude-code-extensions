...
Usage:
    # In ${CLAUDE_PLUGIN_ROOT}/hooks/hooks.json:
    {
      "hooks": {
        "Notification": [{
          "hooks": [{"type": "command", "command": "uv run ${CLAUDE_PLUGIN_ROOT}/hooks/slack_notification.py"}]
        }],
        "Stop": [{
          "hooks": [{"type": "command", "command": "uv run ${CLAUDE_PLUGIN_ROOT}/hooks/slack_notification.py --event-emoji ✅"}]
        }]
      }
    }
"""
