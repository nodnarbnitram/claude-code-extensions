...
Usage:
    # In ${CLAUDE_PLUGIN_ROOT}/hooks/hooks.json:
    {
      "hooks": {
        "Notification": [{
          "hooks": [{"type": "command", "command": "uv run ${CLAUDE_PLUGIN_ROOT}/hooks/discord_notification.py"}]
        }],
        "Stop": [{
          "hooks": [{"type": "command", "command": "uv run ${CLAUDE_PLUGIN_ROOT}/hooks/discord_notification.py --emoji ✅"}]
        }]
      }
    }
...
Testing:
    echo '{"hook_event_name":"Notification","message":"Test","session_id":"test"}' | \\
      uv run ${CLAUDE_PLUGIN_ROOT}/hooks/discord_notification.py
"""
