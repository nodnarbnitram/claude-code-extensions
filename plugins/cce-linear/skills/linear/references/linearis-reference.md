...
**IMPORTANT:** Prefer using wrapper scripts in `${CLAUDE_PLUGIN_ROOT}/skills/linear/scripts/` over calling linearis directly. The scripts handle edge cases and output parsing.
