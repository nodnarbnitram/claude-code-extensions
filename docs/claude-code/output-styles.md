...
These changes apply to the [local project level](./docs/claude-code/settings)
...
### Output Styles vs. [Agents](./docs/claude-code/sub-agents.md)
...
### Output Styles vs. [Custom Slash Commands](./docs/claude-code/commands-reference.md)
