...
<Tip>
  For complete technical specifications and schemas, see [Plugins reference](./docs/claude-code/plugins-reference.md). For marketplace management, see [Plugin marketplaces](./docs/claude-code/plugin-marketplaces.md.
</Tip>

Plugins let you extend Claude Code with custom functionality that can be shared across projects and teams. Install plugins from [marketplaces](./docs/claude-code/plugin-marketplaces.md to add pre-built commands, agents, hooks, Skills, and MCP servers, or create your own to automate your workflows.
...
<Note>
  **Next steps**: Ready to add more features? Jump to [Develop more complex plugins](#develop-more-complex-plugins) to add agents, hooks, and MCP servers. For complete technical specifications of all plugin components, see [Plugins reference](./docs/claude-code/plugins-reference.md).
</Note>
...
For detailed marketplace management including Git repositories, local development, and team distribution, see [Plugin marketplaces](./docs/claude-code/plugin-marketplaces.md).
...
For complete instructions including configuration examples, marketplace setup, and rollout best practices, see [Configure team marketplaces](docs/claude-code/plugin-marketplaces.md#how-to-configure-team-marketplaces).
...
Plugins can include [Agent Skills](./docs/claude-code/agent-skills.md) to extend Claude's capabilities. Skills are model-invoked—Claude autonomously uses them based on the task context.
...
For complete Skill authoring guidance, see [Agent Skills](./docs/claude-code/agent-skills.md).

### Organize complex plugins

For plugins with many components, organize your directory structure by functionality. For complete directory layouts and organization patterns, see [Plugin directory structure](./docs/claude-code/plugins-reference.md#plugin-directory-structure).
...
<Note>
  **For multiple plugins**: Organize plugins in subdirectories like `./plugins/plugin-name` and update your marketplace.json accordingly. See [Plugin sources](./docs/claude-code/plugin-marketplaces.md#plugin-sources) for organization patterns.
</Note>
...
3. **Use validation and debugging tools**: See [Debugging and development tools](./docs/claude-code/plugins-reference.md#debugging-and-development-tools) for CLI commands and troubleshooting techniques
...
<Note>
  For complete technical specifications, debugging techniques, and distribution strategies, see [Plugins reference](./docs/claude-code/plugins-reference.md).
</Note>
...
* **Create your first marketplace**: [Plugin marketplaces guide](./docs/claude-code/plugin-marketplaces.md)
* **Advanced components**: Dive deeper into specific plugin components:
  * [Slash commands](./docs/claude-code/commands-reference.md) - Command development details
  * [Subagents](./docs/claude-code/sub-agents.md) - Agent configuration and capabilities
  * [Agent Skills](./docs/claude-code/agent-skills.md) - Extend Claude's capabilities
  * [Hooks](./docs/claude-code/hooks.md) - Event handling and automation
