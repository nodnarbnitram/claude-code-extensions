docs/claude-code/plugin-marketplaces.md# Plugins reference
...
For complete details on plugin command structure, invocation patterns, and features, see [Plugin commands](docs/claude-code/commands-reference.md).
