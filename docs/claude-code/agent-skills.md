...
Skills can also come from [Claude Code plugins](.docs/claude-code/plugins.md). Plugins may bundle Skills that are automatically available when the plugin is installed. These Skills work the same way as personal and project Skills.
...
**Recommended approach**: Distribute Skills through [plugins](.docs/claude-code/plugins.md).
...
For complete instructions, see [Add Skills to your plugin](.docs/claude-code/plugins.md#add-skills-to-your-plugin).
