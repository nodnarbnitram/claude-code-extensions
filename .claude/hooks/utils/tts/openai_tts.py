...
async def main():
    ...
    api_key = os.getenv("OPENAI_DEV_PLATFORM_EDITOR")
    if not api_key:
        print("❌ Error: OPENAI_DEV_PLATFORM_EDITOR not found in environment variables")
        print("Please add your OpenAI API key to .env file:")
        print("OPENAI_DEV_PLATFORM_EDITOR=your_api_key_here")
        sys.exit(1)
